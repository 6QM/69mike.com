...
这些解释未必只有一个正确答案。它们更像从不同高度绘制的地图：比例尺越大，局部细节越清楚；比例尺越小，结构关系越完整。问题意识不是永远追求更宏大的解释，而是知道自己正在使用哪一张地图，以及这张地图遗漏了什么。

所以，当一个问题长期没有得到解决时，我们或许不应立刻问：“我怎样才能更加努力？”我们可以先问：“我现在努力回答的，究竟是谁提出的问题？这个问题默认了什么目标、什么身份和什么赛场？”

## 二、所谓“Transformer 式的动作”，不是积极思考，而是重新表征问题
...
当投资与自我认同深度绑定时，账户下跌就不只是资产表现不佳，而会变成对人格与判断力的质疑：如果我现在卖出，是否说明我不够聪明？如果这只股票最终上涨，我是否会后悔没有坚持？如果我承认判断错误，过去的研究、时间和损失是否全部失去意义？前景理论把许多风险选择描述为相对于参考点的收益与损失评估，而不只是依据最终财富水平；同一结果的不同表述框架也可能改变选择。这一理论为多种偏离期望效用理论预测的行为提供了描述性解释。[^2]
...
Intel 的案例更接近这篇文章的核心：组织同样会被原来的问题困住。1968 年，戈登·摩尔和罗伯特·诺伊斯创办 Intel 时，半导体存储器不是产品组合中的普通一项，而几乎就是公司对“我们是谁”的回答。1970 年推出的 1103 DRAM 推动半导体存储器取代磁芯存储，并在次年成为当时全球销量最大的半导体器件。存储器由此承载了 Intel 的创业历史、工程荣誉和组织身份。要求 Intel 离开 DRAM，不像关闭一条表现不佳的产品线，更像承认：曾经创造自己的那项能力，已经不能继续定义自己的未来。[^4]

到了 20 世纪 80 年代，日本厂商凭借制造质量与成本优势，把 DRAM 推向更激烈的商品化竞争。其他产品的利润一度掩盖了存储器业务的恶化，也使周期性复苏仍有希望的判断看起来并非毫无道理。1985 年中期，时任 Intel 总裁安迪·格鲁夫和董事长兼 CEO 戈登·摩尔已经掌握价格、需求和亏损等信息，却仍反复争论。格鲁夫后来回忆，他问摩尔：假如两人被董事会撤换，一个没有历史包袱的新 CEO 会怎么做？摩尔立即回答：退出存储器业务。格鲁夫接着问，既然答案如此清楚，为什么他们不能走出门，再以继任者的身份回来执行？这个问题没有增加任何行业信息，却改变了作出判断的人与过去之间的关系：事实没有变化，参考系变了。[^5]

更重要的是，Intel 并不是在那次谈话以后才从零转向微处理器。公司早在 1971 年便推出 4004；1981 年，IBM 又选择 Intel 的处理器用于个人电脑。罗伯特·伯格尔曼对 Intel 的研究还发现，在高层正式改变公司战略之前，中层管理者已在日常产能配置中把稀缺的制造资源从 DRAM 转向增长更快的微处理器；到 1984 年，八座晶圆厂中只有一座仍在生产 DRAM。换句话说，公司在行动上已经开始成为一家微处理器公司，只是身份和语言尚未承认这一事实。对个人而言也是如此：一个人嘴上仍然说自己最重视某条道路，但时间、作品、学习和外部反馈已经长期流向另一个方向，真正需要做的可能不是突然转型，而是看清自己事实上正在成为谁。[^6]

Intel 于 1985 年 10 月宣布彻底退出 DRAM，但认知上的清醒并没有免除执行成本。1986 年，公司在行业低谷与重组压力下裁减约 8000 名员工，并录得超过 1.8 亿美元的亏损。[^7] 因此，这个案例的意义不只是“转型成功”，而是揭示了三个更严格的判断：旧路径的竞争基础是否已经改变？新路径是否已经产生真实的客户、利润与能力证据？自己是否愿意承担重新配置资源的短期代价？**一个曾经创造我们的东西，是否因此永久拥有我们的未来？** 一份专业、一个岗位、一项投资或者一个项目，都可能曾经给予我们身份、收入与荣誉，但过去的贡献不能自动转化为未来继续配置资源的权利。

约翰·博格尔的转换则发生在游戏规则层面。当基金行业普遍研究怎样通过主动管理击败市场时，博格尔把问题改写为：如果投资者整体只能获得市场总体回报，而主动交易和管理还会持续产生成本，普通人为什么一定要参加寻找少数赢家的竞赛？他创立 Vanguard，并于 1976 年推出面向个人投资者的 First Index Investment Trust，也就是后来的 Vanguard 500 Index Fund，以低成本持有 S&P 500 成分股，而不是试图挑出少数赢家。[^8] 当别人都在研究如何赢得游戏时，他开始研究：这场游戏的规则是什么，成本由谁承担，还有没有必要用原来的方式参加。

这些案例看起来横跨生物学、心理学、半导体和投资，但共同的方法非常一致：**他们没有急于在旧框架中增加更多答案，而是把旧框架默认不变的东西变成了问题。** 物种不再固定，理性模型不再天然正确，创始业务不再不可放弃，主动管理也不再是唯一赛场。

库恩后来用“范式转换”描述科学中的类似现象：一个范式不仅提供答案，还规定什么算问题、什么算证据、什么方法值得使用。库恩把科学革命中的范式变化比作格式塔转换。外部世界并非由范式凭空创造，但范式会改变观察、问题、证据与可接受解法的组织方式，使研究者面对同一场景时可能看到不同的现象世界。[^9] 更高维的世界并不是凭空出现了更多神秘事物，而是原来被分开理解的事实，突然显现出新的关系。

## 五、我的转向并不是离开投资，而是扩大了资本与投资的定义

加里·贝克尔把教育、在职训练等视为人力资本投资：它们包括直接支出与放弃当期收入的机会成本，并可能提高未来生产率与收入前景。[^10] 但如果“投资自己”只停留在学习和培训，它仍然不能完整解释一个普通人的资产形成过程。一个人可以买很多课程、阅读很多书、掌握很多概念，却没有形成更强的职业能力，也没有留下任何可见作品或带来新的外部机会。学习可以成为投资，也可以成为一种让人感觉自己正在进步的消费。
...
从这个角度看，我面对亏损后完成的并不是从投资转向不投资，而是从单一金融仓位转向更完整的资本组合。我减少了对自己缺乏明显比较优势的金融投机暴露，增加了对写作、AI、网站和内容生产的投入；与此同时，我仍然需要储蓄、金融资产与风险管理，因为人力资本不具备与金融资产同等的流动性，也可能因为失业、疾病、技术变化和市场需求而贬值。Human Capital ETF 不是用人力资本取代金融资本，而是要求两者被放进同一张资产负债表中比较。
...
有关创伤后成长的研究提醒我们，人们主观上认为自己经历逆境后变得更成熟，并不必然意味着随后出现了可观察、可测量的积极改变。一项为期六个月的纵向研究发现，自我报告的“感知成长”没有预测随后在当前状态或日常状态指标上的可测变化；研究者把这一结论明确限定在短期。[^11] 因此，不能因为痛苦已经被写成故事，就认为痛苦已经被转化为资产。
...
**第七步，保存行动产生的残余。** 一次劳动至少应尝试留下某种能够进入下一轮的东西：一笔储蓄、一项技能、一套方法、一个工具、一件作品、一段关系或者一次更准确的判断。复利的核心并不只是收益再次产生收益，而是上一轮的结果被保存下来，重新成为下一轮的起点。
...
[^4]: Intel，[《Intel Celebrates 30 Years of Innovation》](https://www.intel.com/pressroom/archive/releases/1998/CN071898.HTM)，1998；Intel，[《Launching the Memory Systems Business》](https://timeline.intel.com/1970/launching-the-memory-systems-business)。
[^5]: Richard S. Tedlow，[《The Education of Andy Grove》](https://fortune.com/article/andy-grove-fortune-classic/)，*Fortune*，2005。文中思想实验由 Tedlow 转述自安迪·格鲁夫的 *Only the Paranoid Survive*。
[^6]: Robert A. Burgelman，[《Fading Memories: A Process Theory of Strategic Business Exit in Dynamic Environments》](https://doi.org/10.2307/2393493)，*Administrative Science Quarterly*，Vol. 39, No. 1，1994，pp. 24–56；Intel，[《Explore Intel’s History》](https://timeline.intel.com/1970/launching-the-memory-systems-business)。
[^7]: U.S. International Trade Commission，[《64K Dynamic Random Access Memory Components from Japan》](https://www.usitc.gov/publications/701_731/pub1862.pdf)，Publication 1862，1986，p. A-7；Intel，[《1986 Annual Report》](https://www.intel.com/content/dam/www/central-libraries/us/en/documents/2025-05/history-1986-annual-report.pdf)；Richard S. Tedlow，[《The Education of Andy Grove》](https://fortune.com/article/andy-grove-fortune-classic/)，*Fortune*，2005。
[^8]: Paul J. Lim，[《Lives: John C. Bogle ’51》](https://paw.princeton.edu/article/lives-john-c-bogle-51)，*Princeton Alumni Weekly*；Vanguard，[《Vanguard’s history》](https://corporate.vanguard.com/content/corporatesite/us/en/corp/why-vanguard/who-we-are/our-history.html)。
[^9]: Alexander Bird，[《Thomas Kuhn》](https://plato.stanford.edu/entries/thomas-kuhn/)，*Stanford Encyclopedia of Philosophy*。
[^10]: Gary S. Becker，[《Investment in Human Capital: A Theoretical Analysis》](https://www.nber.org/books-and-chapters/investment-human-beings/investment-human-capital-theoretical-analysis)，NBER。
[^11]: Meghan J. Gangel 等，[《Does Perceived Posttraumatic Growth Predict Observed Changes in Current-Standing and State Posttraumatic Growth?》](https://journals.sagepub.com/doi/10.1177/21677026231182329)，*Clinical Psychological Science*，2024。
